    ...
    <div className="font-sans max-w-4xl mx-auto py-10 px-4 sm:px-6 space-y-8">
      ...
      <div className="border rounded-lg p-6 bg-yellow-50">
        ...
        <button
          ...
          className="px-4 py-2 rounded bg-yellow-500 text-white font-medium hover:bg-yellow-600 transition-colors"
        >
      ...
      <div className="border rounded-lg p-6 bg-blue-50">
        <h3 className="text-lg font-semibold mb-3 text-blue-800">Productivity Tips</h3>
